...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form.save()
            send_mail("Welcome to 'Secure thoughts'!", 'Thank you for creating your account.', settings.DEFAULT_FROM_EMAIL, [current_user.email], fail_silently=False)
...
def create_thought(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            thought.save()
            messages.success(request, 'Your thought has been created!')
